...
export class AirportServicesController {
  constructor(private readonly airportServicesService: AirportServicesService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAirportServiceDto: UpdateAirportServiceDto) {
